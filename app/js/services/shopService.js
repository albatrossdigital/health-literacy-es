            ...
            'tiers': [
              {
                'key': 'bronze',
                'label': 'Bronze',                
                'text': 'Sounds like a <strong>Bronze level plan might be right for you</strong>. Bronze plans have lower premiums, but higher deductibles and out-of-pocket costs.',
                'stats': {
                  'premium': '$128',
                  'deductible': '$6,500',
                  'outOfPocket': '$6,500',
              ...
              },
              {
                'key': 'silver',
                'label': 'Silver',
                'text': 'Sounds like a <strong>Silver level plan may be right for you</strong>. Silver level plans are often the most popular with moderate premiums and moderate deductibles and out-of-pocket costs.',
                'stats': {
                  'premium': '$220',
                  'deductible': '$2,050',
                  'outOfPocket': '$6,600',
              ...
              },
              {
                'key': 'gold',
                'label': 'Gold',
                'text': 'Sounds like a <strong>Gold level plan may be right for you</strong>, because you think you will use more health care services. Gold level plans have higher premiums, but lower deductibles and out-of-pocket costs.',
                'stats': {
                  'premium': '$270',
                  'deductible': '$1,000',
                  'outOfPocket': '$3,750',
